...
template <template <typename...> class W, typename... Ts, typename... Us,
    typename Ability>
struct has_ability_impl<W<abilities_t<Ts...>, Us...>, Ability>
    : mp_eval_if<mp_contains<abilities_t<Ts...>, Ability>, mp_true,
          has_ability_impl, W<Us...>, Ability> {};

template <template <typename...> class W, typename T, typename... Us,
    typename Ability>
struct has_ability_impl<W<T, Us...>, Ability>
    : has_ability_impl<W<Us...>, Ability> {};
} // namespace detail
